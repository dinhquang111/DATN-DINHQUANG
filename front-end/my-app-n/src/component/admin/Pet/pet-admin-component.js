...
import routes from './pet-router'
class PetAdminComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            CheckC: true
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PetAdminComponent))