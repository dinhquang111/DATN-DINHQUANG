...
import routes from './origin-router'
class OrginAdminComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            CheckC: true
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OrginAdminComponent))